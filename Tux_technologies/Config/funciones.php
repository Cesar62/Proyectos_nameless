...
function soloImagenes(string $tipoImagen)
{
    $archivosPermitidos = ["image/png", "image/jpg", "image/jpeg", "image/gif", "image/webp"];

    if (!in_array($tipoImagen, $archivosPermitidos)) {
        return true;
    }else{
        return false;
    }
